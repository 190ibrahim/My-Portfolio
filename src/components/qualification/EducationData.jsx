let EducationData = [
  {
    id: 1,
    title: {
      en: "MSc Intelligent Field Robotic Systems (IFRoS)",
      de: "MSc Intelligent Field Robotic Systems (IFRoS)",
    },
    institution: {
      en: "University of Girona / University of Zagreb",
      de: "Universität Girona / Universität Zagreb",
    },
    location: {
      en: "Girona, Spain / Zagreb, Croatia / Berlin, Germany",
      de: "Girona, Spanien / Zagreb, Kroatien / Berlin, Deutschland",
    },
    link: "https://ifrosmaster.org/",
    scholarship: {
      en: "Erasmus Mundus Joint Master Scholarship",
      de: "Erasmus Mundus Joint Master Scholarship",
    },
    description: [
      {
  ...
  },
  {
    ...
    description: [
      {
        en: "Graduated with a Bachelor's degree in Computer Science, with strong foundations in algorithms, data structures, software engineering, and applied mathematics — funded by the Stipendium Hungaricum Scholarship awarded for outstanding academic achievement",
